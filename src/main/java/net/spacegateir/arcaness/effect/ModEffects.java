package net.spacegateir.arcaness.effect;;
...
import net.spacegateir.arcaness.effect.effects.*;
...
public class ModEffects {
    ...
    private static StatusEffect registerStatusEffect(String name, StatusEffect statusEffect) {
        return Registry.register(Registries.STATUS_EFFECT, new Identifier(ArcaneSteppingStones.MOD_ID, name), statusEffect);
    }

    public static void registerEffects() {
        ArcaneSteppingStones.LOGGER.info("Registering Mod Effects for " + ArcaneSteppingStones.MOD_ID);
    }
}